...
*** Analysis (5): Add different baselines to your implementation. Potential choices include, but n ot limited to: Constant Baselines, Maximum Distance Baseline, Blurred Baseline, Uniform Baseline, Gaussian Baseline.
